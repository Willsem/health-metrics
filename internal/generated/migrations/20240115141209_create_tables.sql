...
CREATE TABLE "metrics" ("uuid" uuid NOT NULL, "metric_type" character varying NOT NULL, "value" double precision NOT NULL, "date" timestamptz NOT NULL, "user_metrics" uuid NULL, PRIMARY KEY ("uuid"), CONSTRAINT "metrics_users_metrics" FOREIGN KEY ("user_metrics") REFERENCES "users" ("uuid") ON DELETE SET NULL);
