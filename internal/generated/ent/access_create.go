...
func (ac *AccessCreate) SetOwnerID(id uuid.UUID) *AccessCreate {
	ac.mutation.SetOwnerID(id)
	return ac
}

// SetNillableOwnerID sets the "owner" edge to the User entity by ID if the given value is not nil.
func (ac *AccessCreate) SetNillableOwnerID(id *uuid.UUID) *AccessCreate {
	if id != nil {
		ac = ac.SetOwnerID(*id)
	}
	return ac
...
func (ac *AccessCreate) SetUserID(id uuid.UUID) *AccessCreate {
	ac.mutation.SetUserID(id)
	return ac
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (ac *AccessCreate) SetNillableUserID(id *uuid.UUID) *AccessCreate {
	if id != nil {
		ac = ac.SetUserID(*id)
	}
	return ac
...
func (ac *AccessCreate) createSpec() (*Access, *sqlgraph.CreateSpec) {
	...
	if nodes := ac.mutation.OwnerIDs(); len(nodes) > 0 {
		...
		_node.user_given_accesses = &nodes[0]
	...
	if nodes := ac.mutation.UserIDs(); len(nodes) > 0 {
		...
		_node.user_recieved_accesses = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	return _node, _spec
}
