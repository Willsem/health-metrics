...
func (uc *UserCreate) AddMetricIDs(ids ...uuid.UUID) *UserCreate {
...
func (uc *UserCreate) AddGivenAccessIDs(ids ...uuid.UUID) *UserCreate {
	uc.mutation.AddGivenAccessIDs(ids...)
	return uc
}

// AddGivenAccesses adds the "given_accesses" edges to the Access entity.
func (uc *UserCreate) AddGivenAccesses(a ...*Access) *UserCreate {
	ids := make([]uuid.UUID, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return uc.AddGivenAccessIDs(ids...)
}

// AddRecievedAccessIDs adds the "recieved_accesses" edge to the Access entity by IDs.
func (uc *UserCreate) AddRecievedAccessIDs(ids ...uuid.UUID) *UserCreate {
	uc.mutation.AddRecievedAccessIDs(ids...)
	return uc
}

// AddRecievedAccesses adds the "recieved_accesses" edges to the Access entity.
func (uc *UserCreate) AddRecievedAccesses(a ...*Access) *UserCreate {
	ids := make([]uuid.UUID, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return uc.AddRecievedAccessIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.GivenAccessesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := uc.mutation.RecievedAccessesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
