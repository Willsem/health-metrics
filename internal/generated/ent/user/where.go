...
// HasGivenAccesses applies the HasEdge predicate on the "given_accesses" edge.
func HasGivenAccesses() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasGivenAccessesWith applies the HasEdge predicate on the "given_accesses" edge with a given conditions (other predicates).
func HasGivenAccessesWith(preds ...predicate.Access) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newGivenAccessesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasRecievedAccesses applies the HasEdge predicate on the "recieved_accesses" edge.
func HasRecievedAccesses() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasRecievedAccessesWith applies the HasEdge predicate on the "recieved_accesses" edge with a given conditions (other predicates).
func HasRecievedAccessesWith(preds ...predicate.Access) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newRecievedAccessesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
